...
public class DateUtilTest {
	...
	public void strToDate22() {
		Date date1 = DateUtil.timestampToDate(1547861802049L);
		Date date2 = DateUtil.timestampToDate(1550713992108L);
		System.out.println(date1);
		System.out.println(date2);

//		Date date3 = DateUtil.timestampToDate(1550714072017L);
//		Date date4 = DateUtil.timestampToDate(1550671372093L);
...
//		System.out.println(date4);
	...
	@Test
	public void getTime() {
		Date date1 = DateUtil.strToDate("2018-01-10 15:10:10");
...
//		Date endTime = DateUtil.strToDateShort("2019-01-12");
	...
	public void addDay_test1() {
		...
		System.out.println(DateUtil.dateToStr(date3));
		//前一天
	...
	public void getStartTimeOrEndTime() {
		...
		System.out.println(DateUtil.dateToStr(startTime));
		//2017-1-11 0:00:00
	...
	public void getFirstDayByAddMonth_test() {
		Date date = DateUtil.strToDate("2017-01-10 15:10:10");//2017-01-10 15:10:10  周二 
		//2017-1-1 0:00:00
		Date monthStartTime =  DateUtil.getFirstDayByAddMonth(date, 0);
		System.out.println(DateUtil.dateToStr(monthStartTime));
		//2017-2-1 0:00:00
		Date monthEndTime =  DateUtil.getLastDayByAddMonth(date, 0);
		System.out.println(DateUtil.dateToStr(monthEndTime));
	}
...
//	}
	...
	public void getFirstDayOfYear_test() {
		...
		System.out.println(DateUtil.dateToStr(firstDayOfYear));
	...
	public void getDates_test() {
		Date startTime = DateUtil.strToDate("2018-07-01 00:00:00");
		Date endTime = DateUtil.strToDate("2018-07-03 23:59:59");
...
//		list.add(DateUtil.dateToStr(tempStartTime, "yyyy/MM/dd"));
//		for (int i = 0; i < dayDiff; i++){
//			tempStartTime = DateUtil.addDay(tempStartTime, 1);
//			list.add(DateUtil.dateToStr(tempStartTime, "yyyy/MM/dd"));
//		}
		for (int i = 0; i <= dayDiff; i++){
			list.add(DateUtil.dateToStr(DateUtil.addDay(tempStartTime, i), "yyyy/MM/dd"));
		}
	...
	public void timestampToDate() {
		Date date1 = DateUtil.timestampToDate(1533571200000L);
		System.out.println(DateUtil.dateToStr(date1));

		Date date2 = DateUtil.timestampToDate(1533657599000L);
		System.out.println(DateUtil.dateToStr(date2));
	}
	...
	public void getWeekOfYear() {
		Date date1 = DateUtil.strToDate("2018-01-07 00:00:00");
