...
public class StringUtilTest {
	...
	@Test
	public void test3() {
//		String lastRechargeTime = "2018-10-10 12:11:10.55";
//		lastRechargeTime = lastRechargeTime.substring(0, lastRechargeTime.lastIndexOf("."));
//		System.out.println(lastRechargeTime);

//		String s = "qq123456";
//		String md5Hex = DigestUtil.md5Hex(s);
//		System.out.println(md5Hex);

		//下面将结果转化成百分比
		BigDecimal resultBg = new BigDecimal("0.5565");
		NumberFormat percent = NumberFormat.getPercentInstance();
		percent.setMaximumFractionDigits(2);
		String format = percent.format(resultBg.doubleValue());
